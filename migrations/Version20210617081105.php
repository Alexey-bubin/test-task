...
final class Version20210617081105 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE `order` (id INT AUTO_INCREMENT NOT NULL, partner_id INT DEFAULT NULL, payment_type_id INT DEFAULT NULL, user_id INT DEFAULT NULL, product_id INT DEFAULT NULL, date DATETIME NOT NULL, comision float(12,2) NOT NULL, status INT NOT NULL, INDEX IDX_F52993989393F8FE (partner_id), INDEX IDX_F5299398DC058279 (payment_type_id), INDEX IDX_F5299398A76ED395 (user_id), INDEX IDX_F52993984584665A (product_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE `order` ADD CONSTRAINT FK_F52993984584665A FOREIGN KEY (product_id) REFERENCES order_products (id)');
